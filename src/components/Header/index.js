        ...
        <>
            <header className="header">
                <div className=" d-flex justify-content-between p-3 mb-5">
                    ...
                    <div>
                        <NavLink to="/" exact
                                 className=" header-link  me-3 text-decoration-none  fs-4 "> Homepage</NavLink>
                        <NavLink to="/news"
            ...
            <CSSTransition in={isOpen} timeout={200}  unmountOnExit     classNames="my-node">
                <div className="modal-window">
                    <div className="modal-cont">
                        {
                            sentSuccess ? <h4>"Successfully sent"</h4> :
                                <Form className="" onSubmit={handleSubmit}>
                                    <Form.Group className="mb-3 " controlId="formBasicName">
                                        <Form.Label htmlFor="name">Name</Form.Label>
                                        <Form.Control id="name" type="text" placeholder="Enter name" name="name"
                                                      required value={callback.name} onChange={handleInput}/>
                                    </Form.Group>

                                    <Form.Group className="mb-3 " controlId="formBasicEmail">
                                        <Form.Label htmlFor="email">Email address</Form.Label>
                                        <Form.Control id="email" name="email" type="email" placeholder="Enter email"
                                                      required value={callback.email} onChange={handleInput}/>
                                    ...
                                    <Form.Group className="mb-3" controlId="formBasicPhone">
                                        ...
                                        <Form.Control id="phone" name="phone" type="text" placeholder="phone number"
                                                      required value={callback.phone} onChange={handleInput}/>
                                    </Form.Group>
